...
extension ChatWriteController {
    ...
    func uploadText(_ uid: String, completion: @escaping() -> Void) {
        ...
        let value: [String: Any] = ["uid": uid, "chat": chatBodyTextView.text!, "imgFileName": imgFileName, "timeStamp": timeStamp, "vendor": deviceVendor, "category": category, "commentCount": 0, "reportCount": 0, "FCMToken": FCMToken]
